...
<!-- Content Wrapper. Contains page content -->
  ...
  <section class="content">
    ...
    <div class="card card-info">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form class="form-horizontal" action="<?=PROOT?>teacher/edit_extracurricular/" method="post">
        <div class="card-body">
        ...
        <div class="card-footer">
          <button type="submit" name="editstsubmit" class="btn btn-info float-right">Select</button>
        </div>
        <!-- /.card-footer -->
      </form>
    </div>
