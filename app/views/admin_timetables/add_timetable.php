<?php $this->setSiteTitle('AMCC SMS | Add Time Table'); ?>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Add Time Table Form</h3>
              ...
              <form role="form" action="<?=PROOT?>admin_classes/add_subject" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="subject_id" class="form-control" id="exampleInputPassword1" placeholder="Ex: 6E_20">
                  </div>
                  <div class="form-group">
